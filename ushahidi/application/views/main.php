    ...
    <div class="big-block-bottom">
     ...
     <div class="category">
      ...
      <?php if (!empty($phone_array)) { ?>
         ...
         <p class="example"> #Tripoli Violence in Jabal Mohsen area. Army deployed. Situation under control. Source: Press TV</p> <p class="guide"><?php echo Kohana::lang('ui_main.submit_guide');?> </p>
