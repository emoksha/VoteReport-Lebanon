		...
		<div id="footer">
			<div class="footer-info">
				<ul>
					...
					<li><a href="<?php echo url::base() . "sharikblog/?page_id=11" ?>"><?php echo Kohana::lang('ui_main.help'); ?></a></li>
					<li><a href="<?php echo url::base() . "sharikblog/?page_id=2" ?>"><?php echo Kohana::lang('ui_main.about'); ?></a></li>
					<li><a href="mailto:contact@sharek961.org"><?php echo Kohana::lang('ui_main.contact'); ?></a></li>
					<li><a href="<?php echo url::base(). "sharikblog" ?>"><?php echo Kohana::lang('ui_main.blog'); ?></a></li>
